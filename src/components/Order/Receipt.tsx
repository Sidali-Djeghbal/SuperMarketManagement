    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-6 z-[100] animate-fade-in">
      <div className="bg-[#1a1a1a] rounded-lg w-full max-w-2xl p-8 shadow-xl animate-slide-in">
        ...
        <div className="flex justify-center gap-4 ">
          <button
            onClick={onClose}
            className="px-6 py-3 text-base font-medium border border-blue-500 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-md shadow-lg transition-all duration-200 transform hover:scale-105"
          >
            Close Receipt
          </button>
        </div>
